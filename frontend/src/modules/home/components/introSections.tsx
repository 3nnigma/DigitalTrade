  ...
  const features = [
    {
      ...
      description:
        "Monitor changes in currency, cryptocurrency, and stock prices to make timely decisions.",
      icon: <Coins />,
    },
    {
    ...
    },
    {
      ...
      description:
        "Connect your bank accounts and financial apps for seamless management of all your assets in one place.",
      icon: <Link />,
    },
    {
      title: "Financial Data Analysis",
      description:
        "Utilize our powerful analytical tools to assess income, expenses, and your portfolio's performance.",
      icon: <BarChart />,
    },
    {
    ...
    },
    {
      title: "And Much More",
      description:
        "Take advantage of all our features for effective financial management.",
      icon: <HeartHandshake />,
    },
  ];
  return (
