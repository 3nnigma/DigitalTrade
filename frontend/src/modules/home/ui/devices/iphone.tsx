...
export function Iphone() {
  return (
    <div className="relative z-10 my-4 h-[640px] w-[320px]">
      <div className="relative z-30 h-[640px] w-[320px] rounded-[68px] border border-[#1B1721] bg-black p-[19px] shadow-[inset_0_0_4px_2px_rgb(192,183,205),inset_0_0_0_6px_rgb(52,44,63)] ">
